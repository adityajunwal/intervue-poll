...
function App() {
  ...
  return (
    <>
      {(showScreen) ? (
        isTeacher ? <TeacherScreen /> : <StudentScreen />
      ) :
        <div id='main-container'>
          <div className='hero-section'>
            ...
            <p className='message'>Please select the role that best describes you to begin using the live polling system</p>
            <div className="role-selector">
              <div
                className="option-card"
                onClick={() => { handleRoleChange('student') }}
                style={{ border: !isTeacher ? "3px solid #1D68BD" : "3px solid #D9D9D9", cursor: "pointer" }}
              >
                <span className='title'>I'm a Student</span>
                <p className='description'>Participate in the polls generated by your respected teacher</p>
              </div>
              <div
                className="option-card"
                ...
                style={{ border: isTeacher ? "3px solid #1D68BD" : "3px solid #D9D9D9", cursor: "pointer" }}
              >
                <span className='title'>I'm a Teacher</span>
                <p className='description'>Create Polls for your Students to participate, and see live results</p>
              </div>
            </div>
            <button 
